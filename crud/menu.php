...
?>
 ...
 <head>
	...
	<link rel="stylesheet" type="text/css" href="menu7.css">
 			...
 			if ($resultado->num_rows>0) {?>
 				...
 				<div id="div3">
 					...
 					if ($resultado->num_rows>0)
 					{
 						...
 						<br><br>
 						<input style="width: 40%;" class="btn2 btn-primary" type="button" onclick="location.href='registro_aprendiz.php'" value="Registro de aprendices">
 						...
 						<input style="width: 40%;" class="btn2 btn-primary" type="button" onclick="location.href='Borrar_aprendiz.php'" value="Borrar aprendices">
 						<br><br>
 						<input style="width: 40%;" class="btn2 btn-primary" type="button" onclick="location.href='crear_programa.php'" value="Crear programa">
 						...
 						<input style="width: 40%;" class="btn2 btn-primary" type="button" onclick="location.href='Eliminar_programa.php'" value="Eliminar programa">
 						<br><br>
 						<input style="width: 40%;" class="btn2 btn-primary" type="button" onclick="location.href='Crear_ficha.php'" value="Crear Ficha">
 						...
 						<input style="width: 40%;" class="btn2 btn-primary" type="button" onclick="location.href='Eliminar_ficha.php'" value="Eliminar Ficha">
 						<?php
 					}
 					else
 					{
